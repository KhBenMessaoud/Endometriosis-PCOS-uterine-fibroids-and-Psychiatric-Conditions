# ===== Two-sample MR: Mood disorders -> Endometriosis =====
library(data.table)
library(TwoSampleMR)
library(ieugwasr)
library(tibble)
...
outdir <- file.path("/gpfs/scratch/asgelz01/MR/results", paste0("mood_to_EM_6_", ts))
...
# This file uses 'variant_id' (often chr:pos:ref:alt). If you also have rsids, switch snp_col="rsid".
