...
load(file = "C:/Users/BENMEK01/OneDrive - NYU Langone Health/Documents/Research project/Infertility UKBB/Repro & Hormones X Mental Health/Data intermediate/sensitivity primarycare/matched_datasetFibro_PC.Rdata")
load(file = "C:/Users/BENMEK01/OneDrive - NYU Langone Health/Documents/Research project/Infertility UKBB/Repro & Hormones X Mental Health/Data intermediate/sensitivity primarycare/matched_datasetEndo_PC.Rdata")
load(file = "C:/Users/BENMEK01/OneDrive - NYU Langone Health/Documents/Research project/Infertility UKBB/Repro & Hormones X Mental Health/Data intermediate/sensitivity primarycare/matched_datasetPCOS_PC.Rdata")


# Rename columns to replace "-" with "_"
colnames(matched_datasetEndo_PC) <- gsub("-", "_", colnames(matched_datasetEndo_PC))
colnames(matched_datasetFibro_PC) <- gsub("-", "_", colnames(matched_datasetFibro_PC))
colnames(matched_datasetPCOS_PC) <- gsub("-", "_", colnames(matched_datasetPCOS_PC))
...
matched_datasetFibro_PC <- process_dataset(matched_datasetFibro_PC)
matched_datasetEndo_PC <- process_dataset(matched_datasetEndo_PC)
matched_datasetPCOS_PC <- process_dataset(matched_datasetPCOS_PC)
...
formulas <- list(
  f_3 = "DX_endometriosis + Ethnicity + Migration + Incomes + Degree + Metabolic_overall +  Year.of.birth + IMD_Q" 
)
...
results_all_outcomes <- future_lapply(seq_along(outcome_variables), function(i) {
  process_outcome_optimized(i, outcome_variables, matched_datasetEndo_PC, formulas)
})
...
output_file <- "C:/Users/BENMEK01/OneDrive - NYU Langone Health/Documents/Research project/Infertility UKBB/Repro & Hormones X Mental Health/Output/sensitivity primarycare/overall Endo_PC.xlsx"
...
formulas <- list(
  ...
  f_3 = "DX_PCOS + Ethnicity + Migration + Incomes + Degree + Metabolic_overall +  Year.of.birth + IMD_Q"
...
# Run for each outcome
results_all_outcomes <- future_lapply(seq_along(outcome_variables), function(i) {
  process_outcome_optimized(i, outcome_variables, matched_datasetPCOS_PC, formulas)
})
...
# Save the Excel file with results
output_file <- "C:/Users/BENMEK01/OneDrive - NYU Langone Health/Documents/Research project/Infertility UKBB/Repro & Hormones X Mental Health/Output/sensitivity primarycare/overall PCOS_PC.xlsx"
saveWorkbook(wb, file = output_file, overwrite = TRUE)
...
formulas <- list(
  ...
  f_3 = "DX_Fibroids + Ethnicity + Migration + Incomes + Degree + Metabolic_overall + Year.of.birth + IMD_Q")
...
# Run for each outcome
results_all_outcomes <- future_lapply(seq_along(outcome_variables), function(i) {
  process_outcome_optimized(i, outcome_variables, matched_datasetFibro_PC, formulas)
})
...
# Save the Excel file with results
output_file <- "C:/Users/BENMEK01/OneDrive - NYU Langone Health/Documents/Research project/Infertility UKBB/Repro & Hormones X Mental Health/Output/sensitivity primarycare/overall Fibro_PC.xlsx"
saveWorkbook(wb, file = output_file, overwrite = TRUE)
