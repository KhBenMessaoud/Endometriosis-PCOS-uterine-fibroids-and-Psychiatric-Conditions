...
for i in {1..22}; do
    ...
    --extract snplist_UF.txt \
    --maf 0.01 --geno 0.1 --mind 0.1 --hwe 1e-6 \
    --make-bed --out ukb22418_c${i}_subset_qc_UF"
    ...
    -iin="${project}snplist_UF.txt" \
     -icmd="${run_plink_subset}" --tag="subset" --instance-type "mem2_ssd2_v2_x16" \
