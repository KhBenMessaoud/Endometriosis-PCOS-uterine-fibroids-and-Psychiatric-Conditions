# ===== Two-sample MR: Anxiety Disorders -> Uterine Fibroids =====
library(data.table)
library(TwoSampleMR)
library(ieugwasr)
library(tibble)
...
outdir <- file.path("/gpfs/scratch/asgelz01/MR/results", paste0("anxiety_to_UF_8_", ts))
...
# NOTE: TwoSampleMR will store the variant column into exposure_dat$SNP
# as long as snp_col is set correctly.
