...
output_file <- "C:/Users/BENMEK01/OneDrive - NYU Langone Health/Documents/Research project/Infertility UKBB/Repro & Hormones X Mental Health/Output/MV2/overall Endo.xlsx"
...
# Save the Excel file with results
output_file <- "C:/Users/BENMEK01/OneDrive - NYU Langone Health/Documents/Research project/Infertility UKBB/Repro & Hormones X Mental Health/Output/MV2/overall PCOS.xlsx"
saveWorkbook(wb, file = output_file, overwrite = TRUE)
...
# Save the Excel file with results
output_file <- "C:/Users/BENMEK01/OneDrive - NYU Langone Health/Documents/Research project/Infertility UKBB/Repro & Hormones X Mental Health/Output/MV2/overall Fibro.xlsx"
saveWorkbook(wb, file = output_file, overwrite = TRUE)
