# ===== Two-sample MR: Mood disorders -> Uterine Fibroids =====
library(data.table)
library(TwoSampleMR)
library(ieugwasr)
library(tibble)
...
outdir <- file.path("/gpfs/scratch/asgelz01/MR/results", paste0("mood_to_UF_8_", ts))
...
# NOTE: TwoSampleMR expects exposure_dat$SNP. If your SNP column is "variant_id",
# this will still populate exposure_dat$SNP correctly as long as snp_col="variant_id".
