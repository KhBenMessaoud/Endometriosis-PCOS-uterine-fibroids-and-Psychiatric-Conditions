# ===== Two-sample MR: Schizophrenia -> Uterine Fibroids =====
library(data.table)
library(TwoSampleMR)
library(ieugwasr)
library(tibble)
...
outdir <- file.path("/gpfs/scratch/asgelz01/MR/results", paste0("SCZ_to_UF_8_", ts))
...
# If your SCZ file uses rsid instead of SNP, set snp_col="rsid"
...
# ---- Plots (TwoSampleMR returns lists of ggplots; take [[1]]) ----
