# ===== Two-sample MR: Schizophrenia -> PCOS =====
library(data.table)
library(TwoSampleMR)
library(ieugwasr)
library(tibble)
...
outdir <- file.path("/gpfs/scratch/asgelz01/MR/results", paste0("SCZ_to_PCOS_8_", ts))
...
# If your SCZ file actually uses "rsid" instead of "SNP", change snp_col to "rsid".
