# ===== Two-sample MR: Anxiety Disorders -> PCOS =====
library(data.table)
library(TwoSampleMR)
library(ieugwasr)
library(tibble)
...
outdir <- file.path("/gpfs/scratch/asgelz01/MR/results", paste0("anxiety_to_PCOS_8_", ts))
...
# If your anxiety file has an rsID column, switch snp_col = "variant_id" -> "rsid" (or whatever it’s called).
